...
public class MachineChungus extends BlockDummyable implements ITooltipProvider, ILookOverlay {
	...
	public dummyPos[] getHulls() {
		return combineHulls(
			hullRect(3, 0, 0, 3, 2, 2, true),
			hullRect(4, -4, 0, 3, 1, 1, false),
			hullRect(3, 0, 6, -1, 1, 1, true),
			hullRect(2, 0, 10, -7, 1, 1, true),
			hullSingleBlock(4, 2, 0, true, true),
			hullExtraBlock(-10, 0, 0, true),
			hullExtraBlock(0, 0, 2, true),
			hullExtraBlock(0, 0, -2, true)
		);
	}
	@Override
