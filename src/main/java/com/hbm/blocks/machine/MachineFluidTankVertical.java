...
import com.hbm.tileentity.machine.storage.TileEntityMachineFluidTankVertical;
...
public class MachineFluidTankVertical extends BlockDummyable implements IPersistentInfoProvider, IToolable, ILookOverlay {

	public MachineFluidTankVertical(Material mat) {
		super(mat);
	}

	@Override
	public TileEntity createNewTileEntity(World world, int meta) {
		if(meta >= 12) return new TileEntityMachineFluidTankVertical();
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		...
		if(world.isRemote) {
			...
			TileEntityMachineFluidTankVertical tank = (TileEntityMachineFluidTankVertical) world.getTileEntity(pos[0], pos[1], pos[2]);
	...
	public void onBlockExploded(World world, int x, int y, int z, Explosion explosion) {
		...
		if(!(core instanceof TileEntityMachineFluidTankVertical)) return;

		TileEntityMachineFluidTankVertical tank = (TileEntityMachineFluidTankVertical) core;
	...
	public int getComparatorInputOverride(World world, int x, int y, int z, int side) {
		...
		if(meta >= 6) {
			...
			if(!(te instanceof TileEntityMachineFluidTankVertical))
				return 0;

			TileEntityMachineFluidTankVertical tank = (TileEntityMachineFluidTankVertical) te;
