...
public class RenderFluidTankVertical extends TileEntitySpecialRenderer implements IItemRendererProvider {
	...
	public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float f) {
		...
		TileEntityMachineFluidTankVertical tank = (TileEntityMachineFluidTankVertical) tileEntity;
		...
		if(!tank.hasExploded) {
			ResourceManager.fluidtank_vertical.renderPart("Frame");
			bindTexture(new ResourceLocation(RefStrings.MODID, getTextureFromType(tank.tank.getTankType())));
			ResourceManager.fluidtank_vertical.renderPart("Tank");
		} else {
			ResourceManager.fluidtank_vertical.renderPart("Frame");
			bindTexture(ResourceManager.tank_inner_tex);
			ResourceManager.fluidtank_vertical.renderPart("TankInner");
			bindTexture(new ResourceLocation(RefStrings.MODID, getTextureFromType(tank.tank.getTankType())));
			ResourceManager.fluidtank_vertical.renderPart("Tank");
		}
	...
	public Item getItemForRenderer() {
		return Item.getItemFromBlock(ModBlocks.machine_fluidtank_vertical);
	}
	...
	public IItemRenderer getRenderer() {
		...
		return new ItemRenderBase() {
			...
			public void renderCommonWithStack(ItemStack item) {
				...
				if(!exploded) {
					bindTexture(ResourceManager.tank_tex); ResourceManager.fluidtank_vertical.renderPart("Frame");
					bindTexture(new ResourceLocation(RefStrings.MODID, getTextureFromType(tank.getTankType())));
					ResourceManager.fluidtank_vertical.renderPart("Tank");
				} else {
					bindTexture(ResourceManager.tank_tex); ResourceManager.fluidtank_vertical.renderPart("Frame");
					bindTexture(ResourceManager.tank_inner_tex); ResourceManager.fluidtank_vertical.renderPart("TankInner");
					bindTexture(new ResourceLocation(RefStrings.MODID, getTextureFromType(tank.getTankType())));
					ResourceManager.fluidtank_vertical.renderPart("Tank");
				}
